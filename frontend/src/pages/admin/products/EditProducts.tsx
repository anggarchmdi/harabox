        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold text-stone-400">
              ...
              <span>/</span>
              <span className="text-red-700">Edit Produk #{id}</span>
            </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-2xl border border-stone-200/90 bg-white p-5 sm:p-7 shadow-2xs">
            <div className="mb-5 flex items-center gap-2.5 border-b border-stone-100 pb-4">
              ...
              <div>
                <h2 className="text-sm sm:text-base font-bold text-stone-900">Informasi Produk</h2>
                <p className="text-xs text-stone-500">Sesuaikan nama paket, kategori menu, dan harga satuan</p>
              </div>
            </div>
                ...
                <div>
                  ...
                  {formattedPrice && (
                    <p className="mt-1 text-[11px] font-semibold text-red-600">
                      Harga aktif: {formattedPrice} / porsi
                    </p>
                  )}
                </div>
              </div>
